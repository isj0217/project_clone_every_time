...
import com.example.everytime_mock.src.signup2_inputForms.Signup2_Activity;

public class Signup_1_Activity extends BaseActivity implements SignupActivity_1_View {
        ...
        btn_signUp_1_gotoSignUp_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (chk_1.isChecked() && chk_2.isChecked() && chk_3.isChecked()){
                    Intent intent = new Intent(Signup_1_Activity.this, Signup2_Activity.class);
