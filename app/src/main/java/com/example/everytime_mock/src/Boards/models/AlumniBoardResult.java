...
public class SecretBoardResult {
    ...
    public SecretBoardResult(int contentIdx, String contentWriter, String contentTitle, String contentInf, String noticeName, String contentThumbnailURL, String writeDay, int countLike, int countComment, int countImage) {
