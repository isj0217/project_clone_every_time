...
public class FreshmenBoardAdapter extends RecyclerView.Adapter<FreshmenBoardAdapter.CustomViewHolder> {

    private ArrayList<PostItem> post_item_list;

    private OnItemClickListener mListener = null ;

    public FreshmenBoardAdapter(ArrayList<PostItem> post_item_list) {
    ...
    @NonNull
    @Override
    public FreshmenBoardAdapter.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull FreshmenBoardAdapter.CustomViewHolder holder, int position) {
